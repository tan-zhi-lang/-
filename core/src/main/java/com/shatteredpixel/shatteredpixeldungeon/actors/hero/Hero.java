...
//            put3("升级天赋",false);
    ...
    public String 海克斯描述(String 选择){
        switch(选择){
            ...
            case "大错特错":return "无法使用使用天狗的面具，但是综合属性+150%";
            case "回归基本功":return "打开都解压，系统，挑战，炼狱，派对，赛季，有10%概率视为关闭";
    ...
    public boolean 不能海克斯(String no){
        ...
        (符文("亮出你的枪")&&no.equals("亮出你的剑"))||
        (符文("亮出你的剑")&&no.equals("亮出你的枪"))||
