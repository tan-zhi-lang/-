...
//            }
    ...
    public float 移速() {
        ...
        if(天赋(Talent.追捕猎物)){
            ...
            speed*=1+天赋点数(Talent.追捕猎物,0.15f);
        }
    ...
    if(重生怪物.equals("矮人武僧"))
        ...
        delay/=1+天赋点数(Talent.快攻,0.1f);
            ...
            if(天赋(Talent.兽性猎手)){
                ...
                if(残血)
                delay/=1+天赋点数(Talent.兽性猎手,0.4f);
                else if(半血)
                delay/=1+天赋点数(Talent.兽性猎手,0.2f);
            }
...
//                    mob=new Slime();
        ...
        float 恢复速度=1+天赋点数(Talent.硬肤,0.075f);
