...
public class 死血巫术 extends 巫术 {

	public static final 死血巫术 INSTANCE = new 死血巫术();

	@Override
	public int icon() {
		return HeroIcon.死血巫术;
	}
	...
	public void onCast(灵月法杖 tome, Hero hero) {
		hero.回血(Random.InvNormalIntRange(
				hero.天赋生命力(Talent.死血巫术,0.2f)+
				hero.天赋生命力(Talent.高级死血,0.3f)
				,
				hero.天赋生命力(Talent.死血巫术,0.4f)+
...
//		hero.sprite.showStatusWithIcon(CharSprite.增强,Integer.toString(hero.最大生命(hero.天赋点数(Talent.死血之术,0.2f))),FloatingText.SHIELDING);
	...
	public String desc(){
		String desc = Messages.get(this, "desc",
								   Dungeon.hero.天赋生命力(Talent.死血巫术,0.2f)+
								   Dungeon.hero.天赋生命力(Talent.高级死血,0.3f),
								   
								   Dungeon.hero.天赋生命力(Talent.死血巫术,0.4f)+
