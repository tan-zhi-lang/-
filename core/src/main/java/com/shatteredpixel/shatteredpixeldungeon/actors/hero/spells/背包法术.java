...
public abstract class 背包法术 extends 法术 {

	@Override
	public void onCast(四叶草法典 tome,Hero hero) {
	...
	protected abstract void onItemSelected(四叶草法典 tome,Hero hero,Item item);
