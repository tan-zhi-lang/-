...
import com.shatteredpixel.shatteredpixeldungeon.sprites.商机动画;
...
public class 商机 extends NPC {

	{
		spriteClass = 商机动画.class;
	...
	private static WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public String textPrompt() {
			return Messages.get(商机.class,"sell");
		}

		@Override
		public boolean itemSelectable(Item item) {
			return 商机.canSell(item);
		}
	...
	public boolean interact(Char c) {
		...
		Game.runOnRenderThread(new Callback() {
			...
			public void call() {
				...
				int i = 0;
				options[i++] = Messages.get(商机.this,"sell");
				options[i++] = Messages.get(商机.this,"talk");
