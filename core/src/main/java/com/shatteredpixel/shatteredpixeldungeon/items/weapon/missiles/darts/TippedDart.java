...
public abstract class TippedDart extends Dart {
	...
	public Item merge(Item other) {
		int total = get数量() + other.get数量();
		super.merge(other);
		int extra = total - get数量();
	...
	public static TippedDart getTipped( Plant.Seed s, int quantity ){
		return (TippedDart) Reflection.newInstance(types.get(s.getClass())).get数量(quantity);
	}
