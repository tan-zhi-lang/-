...
public class 冲锋枪 extends Weapon{
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(冲锋枪.class,"prompt");
		}
	};
	...
	public class 子弹 extends Weapon {
		...
		public int 最小投掷攻击(int lvl) {
			return 冲锋枪.this.最小枪械攻击(lvl);
		}
		
		@Override
		public int 最大投掷攻击(int lvl) {
			return 冲锋枪.this.最大枪械攻击(lvl);
		...
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return 冲锋枪.this.hasEnchant(type,owner);
		}

		@Override
		public int 投掷攻击时(Char attacker, Char defender, int damage) {
			return 冲锋枪.this.投掷攻击时(attacker,defender,damage);
		}
