...
public class 狙击枪 extends Weapon{
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(狙击枪.class,"prompt");
		}
	};
	...
	public class 子弹 extends Weapon {
		...
		public float 最大投掷攻击(int lvl) {
			return 狙击枪.this.最大枪械攻击(lvl);
			
		}
		
		@Override
		public float delayFactor(Char user) {
			return 狙击枪.this.delayFactor(user)/2;
		}
		...
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return 狙击枪.this.hasEnchant(type,owner);
		}

		@Override
		public float 投掷攻击时(Char attacker, Char defender, float damage) {
			return 狙击枪.this.投掷攻击时(attacker,defender,damage);
		}
