...
public class 霰弹枪 extends Weapon{
	...
	public void 换弹(){
		...
		if(子弹!=null&&子弹.数量()>0){
			...
			Sample.INSTANCE.play( Assets.Sounds.霰弹枪换弹 );
	...
	private CellSelector.Listener shooter = new CellSelector.Listener() {
		...
		public String prompt() {
			return Messages.get(霰弹枪.class,"prompt");
		}
	};
	...
	public class 子弹 extends Weapon {
		...
		public float 最小投掷攻击(int lvl) {
			return 霰弹枪.this.最小枪械攻击(lvl);
		}
		
		@Override
		public float 最大投掷攻击(int lvl) {
			return 霰弹枪.this.最大枪械攻击(lvl);
		...
		public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
			return 霰弹枪.this.hasEnchant(type,owner);
		}
