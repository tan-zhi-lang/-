...
public class 海克斯卷轴 extends 用品 {
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals(AC_祈愿)&&使用()>0) {
			String b="输入海克斯名字使其权重增加(不能叠加)";
			if(hero.符文("我让你海克斯随机"))b="输入海克斯名字使其权重大大增加(不能叠加)";
	...
	public void 使用(Hero hero){
		...
		if(hero.符文("超级海克斯秘卷"))new 海克斯卷轴(true).清空使用().放背包();
