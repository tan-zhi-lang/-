...
public class Terrain {
	...
	public static final int EMPTY			= 1;//地板
	public static final int GRASS			= 2;//踩踏草
	public static final int EMPTY_WELL		= 3;//干涸井
	public static final int WALL			= 4;//墙
	public static final int DOOR			= 5;//关门
	public static final int OPEN_DOOR		= 6;//开门
	public static final int ENTRANCE		= 7;//出口
	public static final int ENTRANCE_SP		= 37;
	public static final int EXIT			= 8;//入口
	...
	public static final int BARRICADE		= 13;//木障碍
	public static final int EMPTY_SP		= 14;//木地板
	...
	public static final int EMPTY_DECO		= 20;//装饰地板
	public static final int LOCKED_EXIT		= 21;//锁入口
	public static final int UNLOCKED_EXIT	= 22;//开放入口
	public static final int WELL			= 24;//井
	public static final int BOOKSHELF		= 27;//书架
	public static final int ALCHEMY			= 28;//炼金釜
	...
	public static final int CUSTOM_DECO	    = 23;//王座 //invisible decoration that will also be a custom visual, re-uses the old terrain ID for signs
