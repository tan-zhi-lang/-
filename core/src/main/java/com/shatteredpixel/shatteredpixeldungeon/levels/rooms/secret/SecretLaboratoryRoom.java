...
public class SecretLaboratoryRoom extends SecretRoom {
	...
	static{
		...
		potionChances.put(冰霜药剂.class,3f);
		potionChances.put(液火药剂.class,3f);
		potionChances.put(毒气药剂.class,3f);
		potionChances.put(极速药剂.class,          4f);
		potionChances.put(隐形药剂.class,4f);
		potionChances.put(浮空药剂.class,4f);
		potionChances.put(麻痹药剂.class,4f);
