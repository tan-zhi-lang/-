    ...
    public static Image get(Icons type) {
        ...
        switch (type) {
            ...
            case 真坏的:
                ...
                break;
            case 勋章:
                icon.frame(icon.texture.uvRectBySize(112, 48, 16, 15));
                break;
            case CATALOG:
                icon.frame(icon.texture.uvRectBySize(128, 48, 13, 16));
                break;
            case ALCHEMY:
            ...
            case CUBE_CODE:
                ...
                break;
            case 炼狱关:
                icon.frame(icon.texture.uvRectBySizeXY(0, 8));
                break;
            case 炼狱开:
                icon.frame(icon.texture.uvRectBySizeXY(1, 8));
                break;
            case 解压关:
                icon.frame(icon.texture.uvRectBySizeXY(2, 8));
                break;
            case 解压开:
                icon.frame(icon.texture.uvRectBySizeXY(3, 8));
                break;
            case 系统关:
                icon.frame(icon.texture.uvRectBySizeXY(4, 8));
                break;
            case 系统开:
