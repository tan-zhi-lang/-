...
public class v0_2_X_Changes {
	...
	public static void add_v0_2_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.BANDOLIER, null), "New Content",
	...
	public static void add_v0_2_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.POTION_CRIMSON, null), "Balance Changes",
	...
	public static void add_v0_2_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.STONE_AUGMENTATION, null), "Pixel Dungeon v1.7.2",
	...
	public static void add_v0_2_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.GUIDE_PAGE, null), "Story & Signpost Changes",
	...
	public static void add_v0_2_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RING_DIAMOND, null), "New Rings!",
