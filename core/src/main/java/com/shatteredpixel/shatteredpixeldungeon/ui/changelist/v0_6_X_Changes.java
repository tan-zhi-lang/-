...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARMOR_CLOTH, new Bulk().glowing()), "New Curses",
				"Added 4 new curses:\n\n" +
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.STYLUS, null), "Glyph Changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.KIT, null), "Rogue Garb and Huntress Cloak",
	...
	public static void add_v0_6_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CROSSBOW, null), "New Weapons",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.HOLSTER, null), "Inventory changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SEED_SUNGRASS, null), "Seed adjustments",
	...
	public static void add_v0_6_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.TRIDENT, null), "Ranged Weapons Overhaul!",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.CHILLING_DART, null), "Expanded Alchemy",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_TOPAZ, null), Messages.get(RingOfSharpshooting.class, "name"),
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.WAND_MAGIC_MISSILE, null), "Minor Wand buffs",
				"Wand of Corruption:\n" +
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.FLAIL, null), "Weapon and Glyph buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RING_ONYX, null), new RingOfEvasion().trueName(),
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.LOCKED_CHEST, null), "Chest Adjustments",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.IRON_KEY, null), "New Key Display",
		...
		changes.addButton( new ChangeButton(new 双刃(),
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.POTION_GOLDEN, null), "Potion Adjustments",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.REMAINS, null), "Heroes Remains",
	...
	public static void add_v0_6_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.GUIDE_PAGE, null), "Journal Additions",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_TOPAZ, null), new 能量之戒().trueName(),
				"_-_ Added the ring of energy."));
		
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CHEST, null), "Sprites",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_DIAMOND, null), "Ring Mechanics Changes",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_AMETHYST, null), new RingOfWealth().trueName(),
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.VIAL, null), "Dew Vial",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_GARNET, null), new RingOfMight().trueName(),
	...
	public static void add_v0_6_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(new 附魔符石()), "Enchant and Glyph Balance Changes",
