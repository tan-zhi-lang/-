...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.WAND_BLAST_WAVE), "Wand Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RING_AMETHYST, null), "Ring Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.LONGSWORD, new ItemSprite.Glowing( 0x440066 )), "Glyph/Enchant Buffs",
	...
	public static void add_v0_7_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.EXOTIC_BERKANAN), "Ally AI improvements",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.NOISEMAKER, null), "Enhanced Bomb Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.LONGSWORD, new ItemSprite.Glowing(0xFF4400)), "Enchant/Glyph Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.WILD_ENERGY, null), "Misc Item Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARMOR_MAIL, new ItemSprite.Glowing(0x88EEFF)), "Glyph Nerfs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARCANE_BOMB, null), "Enhanced Bomb Nerfs",
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.LONGSWORD, new ItemSprite.Glowing(0xFFFF00)), "Enchantment Changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.KUNAI, null), "New Thrown Weapons",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ELIXIR_ARCANE, null), "New Boss Recipes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CURSE_INFUSE, null), "Boss Recipe Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RING_EMERALD, null), "Other Item Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARMOR_SCALE, new ItemSprite.Glowing( 0x663300 )), "Enchant/Glyph Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARMOR_PLATE, new ItemSprite.Glowing( 0x660022 )), "Enchant/Glyph Nerfs",
	...
	public static void add_v0_7_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.BREW_UNSTABLE, null), "Catalysts!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.LONGSWORD, new ItemSprite.Glowing(0x0000FF)), "Enchantment Overhaul!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.MAGIC_INFUSE, null), "Enchantment Adjustments",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.BREW_INFERNAL, null), "Combination Items",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RING_AMETHYST, null), Messages.get(RingOfWealth.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SPEAR, new ItemSprite.Glowing(0x00FFFF)), "Buffed Enchants",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SEED_SWIFTTHISTLE, null), "Item Balance Adjustments",
	...
	public static void add_v0_7_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.TRIDENT, null), "Thrown Weapon Improvements",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_TOPAZ, null), "Various Item Buffs",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.ARMOR_LEATHER, new ItemSprite.Glowing(0x222222)), "Other Buffs",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.RING_RUBY, null), "Ring Nerfs",
	...
	public static void add_v0_7_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.STONE_BLINK, null), "Runestones",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.EXOTIC_AMBER, null), "Exotic Potions",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.EXOTIC_ISAZ, null), "Exotic Scrolls",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.RETURN_BEACON, null), "New Recipes!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARTIFACT_ARMBAND, null), "Spawn Rate Changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARTIFACT_BEACON, null), "Boss reward changes",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SCROLL_KAUNAN, null), new ScrollOfTeleportation().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SCROLL_ODAL, null), new ScrollOfMirrorImage().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SCROLL_NAUDIZ, null), new ScrollOfTerror().trueName(),
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SCROLL_GYFU, null), new ScrollOfRetribution().trueName(),
