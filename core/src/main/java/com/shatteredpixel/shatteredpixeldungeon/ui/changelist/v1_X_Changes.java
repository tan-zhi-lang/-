...
public class v1_X_Changes {
	...
	public static void add_v1_4_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.GUIDE_PAGE), "Lore Additions",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.MASTERY), "Tutorial Additions",
		...
		changes.addButton(new ChangeButton( new ItemSprite(物品表.LONGSWORD, new ItemSprite.Glowing(0x0000FF)), "Blocking Enchant Redesign",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.SHORTSWORD, new ItemSprite.Glowing( 0x000000 )), "Annoying Curse",
	...
	public static void add_v1_3_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.AMULET), "Harder Ascension Route!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SHORTSWORD, new ItemSprite.Glowing(0x000000)), "Curse Redesigns",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.EXOTIC_ODAL), Messages.get(蜕变秘卷.class, "name"),
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CRYSTAL_KEY), "Crystal Path Rooms",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CLEANSING_DART), "Alchemy Item Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARMOR_LEATHER, new ItemSprite.Glowing(0x000000)), "Curse Nerfs",
	...
	public static void add_v1_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ARTIFACT_ARMBAND), "Armband Rework!",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ENERGY), "Alchemy Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.ROT_DART), "Dart Buffs",
	...
	public static void add_v1_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ENERGY), "Alchemical Energy Overhaul",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.SUMMON_ELE), "New and Reworked Spells",
		...
		changes.addButton( new ChangeButton( new ItemSprite(物品表.EXOTIC_ISAZ), "Exotic Reworks",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ARTIFACT_TOOLKIT), "Artifact Buffs",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CROWN, null), "Talent and Ability Buffs",
	...
	public static void add_v1_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.LIQUID_METAL), "new alchemy recipes!",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.MASTERY), "new player experience improvements",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ANKH), "new ankh mechanics",
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.STONE_FEAR), "runestones",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CROWN, null), "Armor Ability Buffs pt.2",
		...
		changes.addButton( new ChangeButton(new ItemSprite(物品表.CROWN, null), "Armor Ability Nerfs",
