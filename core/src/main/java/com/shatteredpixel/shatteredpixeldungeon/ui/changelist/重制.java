...
public class 重制 {
	...
	public static void add_v1_0_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.护甲修理工具包), "护甲修理工具包",
										   "护甲机制，约和破碎护盾差不多，但是不会随时间流逝，也只能防御物理攻击伤害，包含骷髅死亡爆炸和跳楼受伤(不含流血)。\n" +
										   "最大护甲为25%最大生命。\n" +
										   "巨魔铁匠可以花费人情修复你的护甲。\n" +
										   "商店也会出售此物。\n" +
										   "护甲改成防具，防具可以放入炼金锅转换护甲修理工具包，同奥术树脂。\n" +
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.RING_HOLDER), "戒指",
										   "装甲之戒\n\n" +
										   "_-_ 裸衣+等级~6x(1+等级)的防御，防具+0~2x(1+等级)的防御\n",
										   "魔攻之戒\n\n" +
...
//										   "_-_ 每区域的升级卷轴数量-1。\n" +
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ARMOR_HOLDER), "防具",
										   ...
										   "_-_ 防具完全适配增加闪避，转换效率为根号(力量-防具力量)的3%加成。\n"+
										   "_-_ 防具完全适配增加移速，转换效率为根号(力量-防具力量)的3%加成。\n"+
		...
		changes.addButton( new ChangeButton(new Image(avatar(HeroClass.WARRIOR,tier(HeroClass.WARRIOR))),"英雄",
											...
											"英雄机制\n\n" +
											"_-_ 新增吸血作用于物理攻击的伤害百分比恢复生命值，全能吸血作用于怪物的伤害百分比恢复生命值。\n"+
											"_-_ 任何饱腹填充都能触发吃饭天赋，不过效果倍率是食物填充值/150。\n"+
											"_-_ 搜索会在搜索范围内拾取非陷阱上的物品和打开箱子。\n"+
											"_-_ 视野算法优化，视野范围+光照范围最小8，除非增加视野范围。\n"+
											"_-_ 防具技能移除，矮人国王的皇冠使用为精通，21级后根据等级最多+5最大命中，根据，强化职业。\n"+
											...
											"_-_ 搜索扣的饥饿正确。\n"+
											"_-_ 再生恢复的生命值为延迟值=>1。\n"+
											"_-_ 饥饿首次受伤450*最大生命/1000，后续受伤最大生命/1000=>首次和后续伤害皆为1值。\n"+
											"_-_ 浮空状态在深渊点击自身可以无伤掉下去。\n",
											
											"英雄属性\n\n" +
											"_-_ 最大生命值20+5x等级=>20+4.38x等级。\n"+
											"_-_ 升级不在恢复升级所提升的生命。\n"+
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.PREFS), "杂项",
				...
				"_-_ 巨魔铁匠任务要求数量40=>20，携带的数量越多，增加的好感度越多。新增额外选项，不需要人情，如果还有5000以上金币和50能量会赠送锻造锤。\n"+
				"_-_ 天狗陷阱多显示2秒。\n"+
				"_-_ 粘咕受到燃烧伤害+2。\n"+
