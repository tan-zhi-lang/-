...
public class 重制 {
	...
	public static void add_v1_0_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.RING_HOLDER), "戒指",
										   "装甲之戒\n\n" +
										   "_-_ 裸衣+等级~6x(1+等级)的防御，护甲+0~2x(1+等级)的防御\n",
										   "魔攻之戒\n\n" +
		...
		"虐待\n\n" +
		"_-_ 受到的物理伤害x2.5，如果没有死亡，则恢复受到的伤害。\n"+
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ARTIFACT_CAPE), "荆棘斗篷",
				"回归。\n\n" +
				"_-_ 所有受伤时判定=>所受物理攻击判定。\n" +
				"_-_ 吸收伤害充能倍率50%+5%x神器等级=>500%+25%x神器等级。\n" +
				"_-_ 减伤和反伤为0~受伤=>(200%+10%x神器等级)。\n" +
				"_-_ 移除反伤距离限制和冷却机制。"));
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.RING_HOLDER), "戒指",
										   ...
										   "根骨之戒\n\n" +
										   "_-_ +生命系数1.035=>+等级x15生命。\n"+
										   
										   "狂怒之戒\n\n" +
										   "_-_ 1.09051=>1.091。且所有情况都能使用。\n"+
										   
										   "精准之戒\n\n" +
										   "_-_ +等级x攻击范围。并且最大命中提升1.3系数=>等级x2最小和最大命中。\n"+
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.WEAPON_HOLDER), "武器",
										   "_-_ 装备和卸下时间1=>攻速\n" +
										   "_-_ 扔出装备的戒指和武器时，只花费扔出的时间，不花费卸下的时间。\n"+
										   "_-_ 所有武器伤害倍率大于和小于1的最小和最大伤害，能从升级正确分配伤害。\n"+
										   "_-_ 近战武器最小伤害=阶+级、最大伤害=5x(阶+1)+级x(阶+1)不同武器调整5的值=>不同武器x伤害倍率来改动。\n" +
										   "_-_ 投掷武器最小伤害=2*阶+级、最大伤害=5x阶+级x阶不同武器调整5的值=>不同武器x伤害倍率来改动。\n" +
										   "_-_ 武器投掷最小攻击2x阶+等级=>(阶+等级)x0.85。\n" +
										   "_-_ 武器完全适配增加命中，转换效率为根号(力量-武器力量)的3%加成。\n" +
										   "_-_ 武器完全适配增加攻速，转换效率为根号(力量-武器力量)的3%加成。\n" +
										   "_-_ 大部分武器属性所有调整，阶级有所下降，一部分重叠类型武器删除。\n" +
										   "_-_ 武器部分格挡量能根据等级提升。\n" +
										   "_-_ 空手攻速1=>2。\n" +
										   "_-_ 根据力量增加命中，转换效率为根号(力量-8)x3%。\n" +
										   "_-_ 根据力量增加攻速，转换效率为根号(力量-8)x3%。"
										   ));
		
		
		
		changes.addButton(new ChangeButton(new ItemSprite(物品表.ARMOR_HOLDER), "护甲",
										   "_-_ 护甲装备和卸下时间1=>攻速x移速x6。\n"+
										   "_-_ 护甲完全适配增加闪避，转换效率为根号(力量-护甲力量)的3%加成。\n"+
										   "_-_ 护甲完全适配增加移速，转换效率为根号(力量-护甲力量)的3%加成。\n"+
										   "_-_ 裸衣增加闪避，转换效率为根号(力量-8)的3%加成。\n"+
										   "_-_ 裸衣增加移速，转换效率为根号(力量-8)的3%加成。"
		));
		changes.addButton(new ChangeButton(new ItemSprite(物品表.STONE_AUGMENTATION), "强化符石",
										   "武器\n\n" +
										   "_-_ 新增+30%最大命中\n" +
										   "_-_ +伤害50%-67%攻速x(等级+2)=>+10%伤害。\n" +
										   "_-_ +33%攻速-30%伤害x(等级+2)=>+20%攻速。",
										   
										   "护甲\n\n" +
										   "_-_ 新增+20%移速\n" +
										   "_-_ +100%防御-200%闪避x(等级+2)=>+10%防御。\n" +
										   "_-_ +200%闪避-100%防御x(等级+2)=>+30%闪避。"));
		
		changes.addButton( new ChangeButton(new Image(avatar(HeroClass.WARRIOR,tier(HeroClass.WARRIOR))),"英雄",
											"英雄初始\n\n" +
											"_-_ 英雄初始不携带口粮。\n"+
											"_-_ 各英雄都拥有特定的效果，武器装备更符合设定。\n"+
											"_-_ 除了战士都移除水袋，护甲都变成专属护甲。\n",
											...
											"_-_ 天赋解锁从2/7/13=>2/5/11\n" +
											"_-_ 天赋点数5/6/8=>3/6/9\n" +
											"_-_ 二层和三层最大天赋点+1",
											
											"英雄机制\n\n" +
											"_-_ 任何饱腹填充都能触发吃饭天赋，不过效果倍率是食物填充值/150。\n"+
											"_-_ 搜索会在搜索范围内拾取非陷阱上的物品和打开箱子。\n"+
											"_-_ 视野算法优化，视野范围+光照范围不得超过视野范围，除非增加视野范围。\n"+
											"_-_ 护甲技能移除，矮人国王的皇冠使用为精通，21级后根据等级最多+10最大生命和最大命中，根据，强化职业。\n"+
											"_-_ 状态栏添加食物条。并且不显示Buff图标。\n"+
											"_-_ 先处理物理防御时然后处理物理攻击时=>先处理物理攻击时然后处理物理防御时。\n"+
											"_-_ 吃饭回血食物填充/150的生命。\n"+
											"_-_ 伏击+1伤害，隐形伏击再+1，敌人第一次被伏击再+1。\n"+
											"_-_ 新增暴击率和暴击伤害，默认4%暴击率，和175%暴击伤害。\n"+
											...
											"_-_ 搜索扣的饥饿正确。\n"+
											"_-_ 再生恢复生命延迟=>1。\n"+
											"_-_ 饥饿首次受伤450*最大生命/1000，后续受伤最大生命/1000=>首次和后续伤害皆为1。\n"+
											"_-_ 浮空状态在深渊点击自身可以无伤掉下去。\n",
											
											"英雄属性\n\n" +
											"_-_ 升级不在恢复升级所提升的生命。\n"+
											"_-_ +0.25命中和闪避。最大等级-5。\n"+
											"_-_ 升级所需经验初始10+5/(级-1)=>10+10/级。"));
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.PREFS), "杂项",
				...
				"_-_ 暗金矿可以提炼获得25炼金能量。\n" +
				"_-_ 武器和护甲、神器、法杖和戒指可以提炼，提炼量是金币的2.5%+1，投掷武器是金币的(2.5%/数量+1)x数量。。\n" +
				"_-_ 物品可以重命名。\n" +
				...
				"_-_ 下水道巨蛇最大攻击+2。\n"+
				"_-_ 疯狂小偷移速83.33%=>75%，防御时掉落1金币=>30+地牢层数x10, 60+地牢层数x20。\n"+
				"_-_ 野心勃勃的小恶魔不再半透明。\n"+
				"_-_ 豺狼诡术师接近它后，移速会只有75%。其他情况的移速100%=>125%。。\n"+
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.破损纹章), "破损纹章",
				"_-_ 初始护盾3+2x护甲阶级=>护甲阶级x(1+护甲等级)。\n" +
				"_-_ 半血受伤获得=>受伤获得。\n" +
				"_-_ 提升护甲的等级改成强化等级。\n" +
				"_-_ 可额外携带1级，冷却150=>100。"));
