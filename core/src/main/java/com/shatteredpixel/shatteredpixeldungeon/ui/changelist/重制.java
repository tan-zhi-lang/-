...
public class 重制 {
	...
	public static void add_v1_0_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new ItemSprite(物品表.WEAPON_HOLDER), "武器",
										   "_-_ 装备和卸下时间1=>攻速\n" +
										   "_-_ 武器战技重做\n" +
										   "_-_ 武器范围>1时，那么设定x，x为范围。第x次攻击造成伤害+15%x(4-x)，1范围后会会重置为最初的范围。\n" +
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.AUDIO), "音效",
											"_-_ 一些物品音效。\n" +
											"_-_ 一些怪物音效。\n" +
											"_-_ 一些杂项音效。" ));
		...
		changes.addButton( new ChangeButton(new RatSprite(),"怪物",
											"_-_ 大部分怪物正确获得属性。\n"+
											"_-_ 1楼刷怪不会刷怪=>50x25回合后才会刷怪。\n"+
											"_-_ 1楼刷怪数量8=>9。\n"+
											"_-_ 怪物生成不会在出口上。\n"+
											"_-_ 怪物生成可以在物品上。\n"+
											"_-_ 宝箱怪动画优化。\n"+
											"_-_ 食人鱼现在会优先去吃生肉，并产生一个新的食人鱼，不过每个食人鱼只能产生一次。\n"+
											"_-_ 新增植物、酸性和寒冰属性的生物受到火焰伤害x1.45。\n"+
											"_-_ 新增火焰属性的生物受到寒冰伤害x1.45。\n"+
											"_-_ 新增暴击率和暴击伤害，默认6%暴击率，和145%暴击伤害。如果不是百分比暴击，首次攻击必定不暴击，且400/暴击率次物理攻击未暴击则下次必定暴击，暴击后重置。\n"+
											"_-_ 新增机械属性的生物受到电伤害x1.45。\n"+
											"_-_ 新增动物属性的生物受到流血、中毒、毒气、酸性、火焰和寒冰伤害x1.45。\n"+
											"_-_ 怨灵最大生命1=>地牢层数。\n"+
...
//				"_-_ 3区没下矿墙壁镶嵌的是秘银，也能被镐子挖取。\n" +
		...
		changes.addButton(new ChangeButton(bug, "修复",
				...
				"_-_ 修复高等级数据溢出，限制25级戒指，再升级会获得10能量。\n" +
				"_-_ 修复潜在相关透视可能黑幕。\n" +
				"_-_ 修复饥饿速率不对受伤修正。\n" +
