...
public class 重制改动{
	...
	public static void 怪物(ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton(Icons.get(Icons.PREFS),"怪物",
											...
											"新增6%暴击率和145%暴击伤害，超过的暴击率33%转暴击伤害。如果不是百分比暴击，首次攻击必定不暴击，且600/暴击率次攻击未暴击则下次必定暴击，暴击后重置。\n"+
		...
		changes.addButton( new ChangeButton(new Wraith(),"最大生命1=>地牢层数。 "));
		changes.addButton( new ChangeButton(new Bat(),"攻击恢复血量1~14(攻击-4)=>3~9(吸血50%)。\n"+
		...
		changes.addButton( new ChangeButton(new Snake(),"最小和最大攻击+2，攻速x2，最大生命+6，最大防御+1，最大闪避25=>5，最大等级7=>8，并且替换二层豺狼巡查。"));
...
//		new RenderedText(cleanStr,size)
		...
		changes.addButton( new ChangeButton(Icons.CHALLENGE_COLOR.get(), "挑战",
											"精英强敌，新增噩梦精英攻击+35%，攻速+50%。冰寒精英攻击+25%，且攻击15%概率冻结1.5回合，免疫冻伤和冻结。暴击率+30%，吸血+25%。。\n" +
