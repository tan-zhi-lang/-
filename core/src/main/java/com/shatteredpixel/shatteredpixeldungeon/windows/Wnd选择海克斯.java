...
public class Wnd选择海克斯 extends Window {
	...
	public Wnd选择海克斯(海克斯宝典 i,String s1,String s2,String s3,Hero hero){
		super();
		INSTANCE=this;
		...
		IconButton clsInfo = new IconButton(Icons.get(Icons.INFO)){
			@Override
			protected void onClick() {
				GameScene.show(new WndTitledMessage(new ItemSprite(物品表.海克斯宝典),final海克斯1,hero.海克斯描述(final海克斯1)));
			}
		};
		...
		IconButton clsInfo2 = new IconButton(Icons.get(Icons.INFO)){
			@Override
			protected void onClick() {
				GameScene.show(new WndTitledMessage(new ItemSprite(物品表.海克斯宝典),final海克斯2,hero.海克斯描述(final海克斯2)));
			}
		};
		...
		IconButton clsInfo3 = new IconButton(Icons.get(Icons.INFO)){
			@Override
			protected void onClick() {
				GameScene.show(new WndTitledMessage(new ItemSprite(物品表.海克斯宝典),final海克斯3,hero.海克斯描述(final海克斯3)));
			}
		};
